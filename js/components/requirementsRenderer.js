...
const A9_MARKDOWN = `# A9 · Topic Library
...
| **Không phải cuộc thi nào** | Ép con sưu tập thật nhiều huy thương/chứng chỉ phong trào để làm đẹp hồ sơ. | Mỗi cuộc thi đều có một cái giá (thời gian, áp lực tâm lý, chi phí cơ hội). Cha mẹ cần tính toán ROI thực chất: *"Cuộc thi này mua được gì cho năng lực tự học của con?"*. | \`Competency Framework\`<br>\`Building 21\` |
