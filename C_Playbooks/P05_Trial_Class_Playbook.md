...
Đánh giá chất lượng thực thi Trial Class theo 3 tiêu chuẩn phổ quát (Thang đo L1 – L5, **L3 là Definition of Done ⭐**):
...
| Trụ Cột Đánh Giá | L1 (Chưa Đạt) | L2 (Cơ Bản) | L3 (ĐẠT CHUẨN DoD ⭐) | L4 (Tốt) | L5 (Xuất Sắc) |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **1. Execution** | Không tạo Poll Zalo, để tình trạng no-show cao; quên xuất báo cáo. | Tạo poll muộn, tư vấn chậm trễ sau 48h. | **Tạo Poll Zalo trước 24h; gửi Portal đúng hạn; hoàn tất tư vấn Fit Judgment trong 24h sau Trial.** | Phối hợp mượt mà, giải quyết sự cố kỹ thuật của học sinh tức thì trong giờ học. | Tỷ lệ học sinh tham gia đủ 2 buổi đạt $\ge 95\%$, quy trình tự động hóa hoàn hảo. |
...
| **3. Parent Conversion** | Phụ huynh bất mãn, đánh giá buổi học lãng phí thời gian. | Phụ huynh xem xong không phản hồi. | **Tỷ lệ chuyển đổi nhập học tự nhiên $\ge 40\%$; $100\%$ phụ huynh nhận được giá trị rõ ràng.** | Phụ huynh chủ động đăng ký và giới thiệu thêm con của bạn bè cùng học. | Phụ huynh trở thành đại sứ lan tỏa uy tín trung thực của Nemo12. |
