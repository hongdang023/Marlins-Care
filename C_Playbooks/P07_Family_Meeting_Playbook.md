---
id: P07-FAMILY-MEETING
title: "P07 · Family Meeting Playbook — Nemo12 & Marlins Care"
status: approved
version: "2.0.0"
date: "2026-08-30"
authors: ["Marlins Care Ops", "Mentor & Marlins Host"]
domain: "Operational Playbooks / Retention & Deep Care"
relates_to:
  - "A1_Sitemap.md"
...
```mermaid
gantt
    title Timeline Family Meeting (60 phút)
    dateFormat  HH:mm
    axisFormat  %H:%M
    section Diễn tiến buổi gặp
    Warm-up & Tạo không khí (05p)    :00:00, 05m
    Family Story - Lắng nghe PH (10p):00:05, 10m
    Student Story - Đối thoại cùng con (15p):00:15, 15m
    Alignment - Đúc kết & Phản chiếu (15p)  :00:30, 15m
    Next Steps & Cam kết nhỏ (10p)  :00:45, 10m
    Closing & Tạm biệt (05p)        :00:55, 05m
```
...
<details open>
<summary><h3>🧭 Mentor Guides</h3></summary>
...
<details>
<summary><h3>📝 Family Notes & Dory Integration</h3></summary>

Sau buổi gặp, mentor hoàn thiện bản ghi chép vào **Hệ thống Dory Sensemaking** trong vòng 24 giờ theo cấu trúc chuẩn:

```markdown
# Family Meeting Notes — [Tên Học Sinh] — [Ngày Gặp]

## 1. Core Insights (3 Trục Cốt Lõi)
* Family Dynamics: [Fact & Observation về sự tương tác giữa Bố/Mẹ và Con]
* Learning Environment: [Góc học tập, thiết bị, tiếng ồn, các yếu tố ngoại cảnh]
* Hidden Motivation: [Động lực tự nhiên, sở thích đặc biệt, điều khiến con say mê]

## 2. Dory 6-Axis Tags
* PAIN: [Nỗi đau hoặc băn khoăn lớn nhất của bố mẹ]
* JTBD: [Bài toán cốt lõi gia đình cần giải quyết]
* NEED: [Nhu cầu hỗ trợ đặc thù của học sinh]
* BELIEF: [Niềm tin hoặc định kiến gia đình đang giữ về việc học của con]
* GOAL: [Mục tiêu kỳ vọng trong 1–3 tháng tới]
* FACT: [Dữ liệu khách quan xác thực tại nhà]

## 3. Action Plan & Next Steps
* Mentor Action: [Nhiệm vụ cá nhân hóa cho học sinh trong các buổi học tới]
* Family Action: [Thỏa thuận nhỏ bố mẹ sẽ hỗ trợ con ở nhà]
* Follow-up Date: [Ngày cập nhật tiến độ lại cho gia đình]
```
...
| **Phân Tích & Đánh Đổi (Trade-offs)** | — | Hình thức hành chính rập khuôn, không giải quyết được vấn đề riêng của từng nhà. | Kích hoạt khi học sinh bứt phá vượt bậc hoặc gặp điểm nghẽn tâm lý cần gỡ rối. |
