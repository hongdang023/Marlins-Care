...
function buildSearchIndex() {
  ...
  const playbooks = [
    ...
    { title: "Referrals Program Playbook (P08)", slug: "/playbooks/referrals", category: "Playbook", icon: "🎁", snippet: "Chính sách tri ấn song phương 15% - 15% Tuition Credit cho phụ huynh.", tags: ["P08", "Referrals", "Tuition Credit", "Tri ân"] }
  ];
